...
import amf.core.client.scala.{AMFGraphDocumentClient => InternalAMFGraphDocumentClient}
...
/**
  ...
  */
@JSExportAll
class AMFGraphDocumentClient private[amf] (private val _internal: InternalAMFGraphDocumentClient) {

  private[amf] def this(configuration: AMFGraphConfiguration) = {
    this(new InternalAMFGraphDocumentClient(configuration))
  }
